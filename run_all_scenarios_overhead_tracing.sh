...
for (( i = 0; i < $times; i++ )); do
	...
	mkdir overhead-experiments/tracing/account-service/run-$i
	...
	mkdir overhead-experiments/tracing/statistics-service/run-$i
	...
	mkdir overhead-experiments/tracing/notification-service/run-$i
